                  ...
                  <div className="footer-widget">
                    <div className="footer-widget">
                      ...
                      <ul className="list-unstyled">
                          ...
                          <Media as="li" >
                            <Link to={`/complaint-handling-procedure`}> Complaint Handling Policy </Link>
                          </Media>
                          <Media as="li" >
                            <Link to={`/compliance-monitoring-reporting-procedure`}> Compliance Monitoring & Reporting Procedure </Link>
                          </Media>
                        {/* {configuration
                          ...
                          .map((static_page, index) => (
                            ...
                            >
                              <Link
                                to={`/${static_page.static_page_unique_id}`}
                                key={static_page.static_page_unique_id}
                              >
                                {static_page.title}
                              </Link>
