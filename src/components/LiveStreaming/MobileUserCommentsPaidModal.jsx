...
const MobileUserCommentsPaidModal = (props) => {
  return (
    <>
      <Modal
        ...
        size="md"
        centered
        show={props.mobileUserCommentsPaid}
        onHide={props.closeMobileUserCommentsPaidModal}
      >
...
export default MobileUserCommentsPaidModal;