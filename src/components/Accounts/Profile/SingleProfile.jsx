                            ...
                            <div className="user-right-content-sec">
                                <div className="user-right-info">
                                    ...
                                    <div className="user-info-list">
                                        <ul className="list-unstyled">
                                            {userDetails.data.user.selected_category && userDetails.data.user.selected_category.name &&
                                                <Media as="li">
                                                    <Link to="#">
                                                        <Image
                            ...
                            {userDetails.data.is_block_user == 0 &&
                                <div className="profile-tab-sec">
                                    <Tab.Container id="left-tabs-example" defaultActiveKey="all">
                                        <Row>
                                            <Col sm={12}>
                                                <Nav variant="pills" className={userDetails.data.user.is_content_creator == 2 ? "grid-five-col" : "grid-four-col"}>
                                                    <Nav.Item>
                                                            ...
                                                            <Nav.Link eventKey="product"
                                                                ...
                                                                <span>
                                                                    <Image
                                                                        className="profile-post-tab-icon"
                                                                        src={
                                                                            window.location.origin + "/assets/images/new-home/icon/store-icon.png"
                                                                        }
                                                                    />
                                                                </span>
