                    ...
                    <span>
                      <Image
                        ...
                        src={
                          ...
                          "/assets/images/new-settings/personal-info.png"
                        }
                      />
                    </span>
                  ...
                  <Nav.Link eventKey="add-information">
                    <span>
                      <Image
                        ...
                        src={
                          window.location.origin +
                          "/assets/images/new-settings/additional-info.png"
                        }
                      />
                    </span>
                    <span className="resp-display-none">
                  ...
                  <Nav.Link eventKey="subscription-plans">
                    <span>
                      <Image
                        ...
                        src={
                          window.location.origin +
                          "/assets/images/new-settings/subscription-plans.png"
                        }
                      />
                    </span>
                    <span className="resp-display-none">
                  ...
                  <Nav.Link eventKey="social-media-links">
                    <span>
                      <Image
                        ...
                        src={
                          window.location.origin +
                          "/assets/images/new-settings/social-link.png"
                        }
                      />
                    </span>
                    <span className="resp-display-none">
                                      ...
                                      <InputGroup.Text id="basic-addon2">
                                        <span>
                                          <Image
                                            ...
                                            src={
                                              window.location.origin +
                                              "/assets/images/new-settings/map-marker-icon.png"
                                            }
                                          />
                                        </span>
                                      </InputGroup.Text>
