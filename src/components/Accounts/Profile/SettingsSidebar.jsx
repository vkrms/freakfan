...
const SettingsSidebar = (props) => {
    ...
    console.log(props.profile.data.cover);
                            ...
                            <Media as="li">
                                <Link to="/audio-calls-sent">
                                    <Image
                                        className="new-setting-list-icon"
                                        src={
                                            window.location.origin + "/assets/images/new-settings/outgoing-audio-call.png"
                                        }
                                    />
                            ...
                            <Media as="li">
                                <Link to="/audio-calls-received">
                                    <Image
                                        className="new-setting-list-icon"
                                        src={
                                            window.location.origin + "/assets/images/new-settings/incommig-audio-call.png"
                                        }
                                    />
