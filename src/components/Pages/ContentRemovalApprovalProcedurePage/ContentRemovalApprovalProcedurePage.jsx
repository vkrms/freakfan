...
import "./ContentRemovalApprovalProcedurePage.css";
...
class ContentRemovalApprovalProcedurePage extends Component {
    ...
    return (
      <>
        <div className="static-page-sec">
          <Container>
            <h4 className="head-title">Content Review Approval Procedure</h4>
            <Row>
              <Col sm="12" md="12">
...
export default connect(mapStateToPros, mapDispatchToProps)(translate(ContentRemovalApprovalProcedurePage));
