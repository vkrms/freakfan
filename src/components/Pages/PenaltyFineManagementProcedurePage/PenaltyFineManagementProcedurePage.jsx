...
import "./PenaltyFineManagementProcedurePage.css";
...
class PenaltyFineManagementProcedurePage extends Component {
                ...
                <div className="static-box">
                  <div className="content-box">
                    ...
                    <ol>
                     ...
                     <p>Please review this complete **Penalty &amp; Fine Management Procedure** to ensure it accurately reflects your requirements for managing penalties, fines, and indemnification for content providers on the Freak Fan platform.</p>                    
                  </div>
...
export default connect(mapStateToPros, mapDispatchToProps)(translate(PenaltyFineManagementProcedurePage));
