import {
  ...
  AUDIO_CALL_CHARGES_UPDATE_SUCCESS,
  AUDIO_CALL_CHARGES_UPDATE_FAILURE,
  VIDEO_CALL_CHARGES_UPDATE_START,
  VIDEO_CALL_CHARGES_UPDATE_SUCCESS,
  VIDEO_CALL_CHARGES_UPDATE_FAILURE,
...
const PostReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case AUDIO_CALL_CHARGES_UPDATE_START:
      return {
        ...state,
        audioCallCharge: {
          data: {},
    ...
    case AUDIO_CALL_CHARGES_UPDATE_SUCCESS:
      return {
        ...state,
        audioCallCharge: {
          data: action.data,
    ...
    case AUDIO_CALL_CHARGES_UPDATE_FAILURE:
      return {
        ...state,
        audioCallCharge: {
          data: {},
    ...
    case VIDEO_CALL_CHARGES_UPDATE_START:
      return {
        ...state,
        videoCallCharge: {
          data: {},
    ...
    case VIDEO_CALL_CHARGES_UPDATE_SUCCESS:
      return {
        ...state,
        videoCallCharge: {
          data: action.data,
    ...
    case VIDEO_CALL_CHARGES_UPDATE_FAILURE:
      return {
        ...state,
        videoCallCharge: {
          data: {},
